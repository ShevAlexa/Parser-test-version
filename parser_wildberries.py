...
while True:
    if attempts == 3:
        item = 1
        next_page = driver.find_element(By.XPATH, f'/html/body/div[1]/'
                                                  f'main/div[2]/div/div/div[1]/div[2]/div[2]/div[6]/div/div/a[10]')
        next_page.click()
        attempts = 0
        print('Next Page')
    ...
    while True:
        ...
        try:
            ...
            sale = 100 - float(sale)
            print(f'{item} - {name}, {new_price}, {old_price}, {sale}%')
            break
